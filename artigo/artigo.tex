...
e BLIP \cite{li:2022} abrem uma alternativa --- avaliar imagens por meio
...
\caption{Visão geral do pipeline: modelos, métricas e cenários.
  \checkmark\,=\,aplicado; ---\,=\,não aplicado.}
...
\textbf{(A) GT Vetorial} --- referência = nome da classe em inglês;
\textbf{(B) GT Raster 1m} --- referência = legenda BLIP da ortofoto (NLP)
...
consistente. A contribuição central --- a avaliação cruzada VQA $\times$
GeoPackage --- fornece a evidência mais direta e interpretável: a SR reduz
...
disponíveis em: \url{https://github.com/MarcelFernandesCGEO/cmp617_trabalho_final}.

% ==========================================================================
\section*{Declaração de Uso de Inteligência Artificial Generativa}
% ==========================================================================

Conforme exigido, declara-se o uso de ferramentas de IA generativa neste
...
Todo o conteúdo --- código e texto --- foi integralmente revisado,
